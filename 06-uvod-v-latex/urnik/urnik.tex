...
tip (npr. \fontfamily{plain}{bool} v C++), kjer bi vrednost \fontfamily{plain}{true} predstavljala
dosegljivost, \fontfamily{plain}{false} pa zasedenost.
...
\subsection{Stroge omejitve} % podpodrazdelek
...
\begin{enumerate}
   ...
   $\text{srešacanja}_i$, ki ga sestavlja $\text{predmet}_i$, profesor, ki ta predmet predava,
   ...
   \item Ko preverimo vse proste termine vseh predavalnic, vstavimo $\text{srešacanja}_i$
